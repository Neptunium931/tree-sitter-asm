package io.github.treesitter.jtreesitter.asm;

import java.lang.foreign.*;

public final class TreeSitterAsm {
    ...
    private static final TreeSitterAsm INSTANCE = new TreeSitterAsm();

    private final Arena arena = Arena.ofAuto();
    private volatile SymbolLookup lookup = null;

    private TreeSitterAsm() {}
    ...
    public static MemorySegment language(SymbolLookup lookup) {
        return call(lookup, "tree_sitter_asm");
    }

    private SymbolLookup findLibrary() {
        try {
            var library = System.mapLibraryName("tree-sitter-asm");
